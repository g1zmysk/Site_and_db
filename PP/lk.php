...
<body>
    ...
    <div class="zag2">
        <h3>Запись на поступление</h3>
    </div>
    <div class="form">
        <form action="lk.php" method="POST">
            <input type="text" id="name_z" name="name_z" placeholder="Имя"> <br>
            <input type="text" id="family" name="family" placeholder="Фамилия"> <br>
            <input type="email" id="email" name="email" placeholder="E-Mail"> <br>
            <input type="text" id="phone" name="phone" placeholder="Номер телефона"> <br>
    ...
    <div class="form">
        <form action="lk.php" method="POST">
            ...
            <input type="text" id="problem" name="problem" placeholder="Тема обращения">
            <a href=""><button class="btn-1">Отправить</button></a>
            <?php
